...
/// <summary>
/// Adapter that wraps an existing LLMClientInstance for remote APIs.
/// </summary>
public class RemoteApiAdapter : IBackendAdapter
{
    public string BackendType => "api";
    ...
    private readonly LLMClientInstance _client;
    
    public RemoteApiAdapter(LLMClientInstance client)
    {
        _client = client;
    }
    ...
    {
        // For remote APIs, we assume they're always "connected"
