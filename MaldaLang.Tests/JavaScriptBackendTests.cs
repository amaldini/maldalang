...
public class JavaScriptBackendTests : TestBase
{
    ...
    [Fact]
    public void JsTranspiler_XorDecisionBoundaryExample_CreatesCanvasBeforeStart()
    {
        var sourcePath = PlanningPaths.ResolveRepoFile("Examples", "Games", "xor_decision_boundary.malda");
        var compiler = new Compiler.Compiler();
        var js = compiler.TranspileToJavaScript(sourcePath);

        Assert.Contains("function startBoundary()", js, StringComparison.Ordinal);
...
""");
    ...
    public void JsTranspiler_ShaderBilliardsExample_EmitsShaderCalls()
    {
        ...
        Assert.Contains("stopOrbitBtn", js, StringComparison.Ordinal);
        Assert.Contains("feltFriction", js, StringComparison.Ordinal);
        Assert.Contains("railRest", js, StringComparison.Ordinal);
        Assert.Contains("ballRest", js, StringComparison.Ordinal);
    ...
    public void JsTranspiler_ShaderMandelbrotExample_EmitsShaderCalls()
    {
        ...
        Assert.Contains("id='iterRange'", js, StringComparison.Ordinal);
        Assert.Contains("id='decadeRange'", js, StringComparison.Ordinal);
        Assert.Contains("while ((i < 2048.0))", js, StringComparison.Ordinal);
