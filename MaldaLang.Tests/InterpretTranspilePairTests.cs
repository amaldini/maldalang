...
public class InterpretTranspilePairTests
{
    ...
    [Fact]
    public void AgentsTeamHandoff_SameStdout()
    {
        InterpretTranspilePair.AssertSameFromSource(
            """
            ...
            var hop = team.handoff("Writer", "Reviewer", { path: "a.malda", summary: "add" });
            io.print(hop.ok);
            """,
            "agents-team-handoff");
    }
