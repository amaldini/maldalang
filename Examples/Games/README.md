...
Games kit G0–G16 is landed. Contracts: [`docs/roadmap-games.md`](../../docs/roadmap-games.md). Peer comparison (what the kit still lacks vs Love2D / Pico-8 / Phaser): [`docs/games-2d-gap-analysis.md`](../../docs/games-2d-gap-analysis.md).
