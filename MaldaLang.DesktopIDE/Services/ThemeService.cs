...
public class ThemeService
{
    ...
    private void InitializeThemes()
    {
        ...
        _themes["Blue"] = new Theme
        {
            ...
            PrimaryButtonBackground = Color.FromRgb(37, 86, 140),
            PrimaryButtonForeground = Color.FromRgb(255, 255, 255),
            PrimaryButtonBorder = Color.FromRgb(30, 70, 120),
            PrimaryButtonHover = Color.FromRgb(30, 70, 120),
            PrimaryButtonHoverBorder = Color.FromRgb(25, 60, 105),
