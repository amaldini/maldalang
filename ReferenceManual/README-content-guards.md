...
| `ReferenceManualGrammarCoverageTests` | `36-grammar.html` names the parser constructs it must cover |
...
| `ReferenceManualContentGuardTests.WebUiChapter_NamesEveryRegisteredControlType` | Every `UiControlSpecRegistry` control type appears as `ui.<type>` in `25-web-ui.html` |
