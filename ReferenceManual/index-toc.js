...
const FALLBACK_TOC_CHAPTERS = [
    ...
    { file: "12-input-output.html", title: "Input/Output", num: "12", category: "Standard Library", description: "Console, files, paths, environment, and host I/O" },
    ...
    { file: "16-database.html", title: "Database Support", num: "16", category: "Standard Library", description: "SQL Server and PostgreSQL clients" },
...
const FALLBACK_TOC_CHAPTERS_IT = [
    ...
    { file: "12-input-output.html", title: "Input/Output", num: "12", category: "Standard Library", description: "Console, file, path, ambiente e I/O dell'host" },
    ...
    { file: "16-database.html", title: "Supporto database", num: "16", category: "Standard Library", description: "Client SQL Server e PostgreSQL" },
