...
const FALLBACK_TOC_CHAPTERS = [
    ...
    { file: "16-actors.html", title: "Actors", num: "16", category: "AI & Agents", description: "Actor model and message passing" },
    { file: "17-agent-orchestration.html", title: "Agent Orchestration", num: "17", category: "AI & Agents", description: "LLM clients, agents, tools" },
    { file: "18-graph-memory.html", title: "GraphMemory", num: "18", category: "AI & Agents", description: "Semantic memory system for AI agents" },
    ...
    { file: "21-durable-workflows.html", title: "Durable Workflows", num: "21", category: "AI & Agents", description: "Durable workflow syntax, runtime model, CLI, DLQ, and operations" },
    { file: "22-web-ui-hub.html", title: "Web UI Overview", num: "22", category: "Web", description: "Choose server components, HttpServer pages, or browser JS" },
    { file: "23-web-ui.html", title: "Web UI Server Components", num: "23", category: "Web", description: "Server components, fragments, live updates, and ui.*" },
    { file: "24-http-server-html-ui.html", title: "HttpServer & HTML UI Generation", num: "24", category: "Web", description: "Route-first hosting, @PAGE, @AIPAGE, and HTML generation" },
    { file: "25-browser-javascript-backend.html", title: "Browser JavaScript UI Backend", num: "25", category: "Web", description: "Browser-hosted MALDA compiled to JavaScript" },
    { file: "26-rest-api.html", title: "REST API Server", num: "26", category: "Web", description: "Creating REST APIs" },
    { file: "27-rest-web-client.html", title: "REST Web Client", num: "27", category: "Web", description: "Making HTTP requests to REST APIs" },
    { file: "28-full-stack-development.html", title: "Full-Stack Development with MALDA", num: "28", category: "Web", description: "End-to-end full-stack architecture and implementation flow" },
    { file: "29-dotnet-interop.html", title: ".NET Interop", num: "29", category: "Platform", description: "Loading and using external .NET libraries" },
    { file: "30-device-integration.html", title: "Device Integration", num: "30", category: "Platform", description: "Control physical devices (Arduino, ESP32, IoT, etc.)" },
    { file: "31-personal-assistant.html", title: "Personal Assistant and CLI", num: "31", category: "Platform", description: "Assistant commands, scheduling, and channels" },
    { file: "32-examples.html", title: "Examples", num: "32", category: "Reference", description: "Complete code examples" },
    { file: "33-property-testing.html", title: "Property Testing", num: "33", category: "Reference", description: "Deterministic property tests, shrinking, and regression workflows" },
    { file: "34-grammar.html", title: "Grammar", num: "34", category: "Reference", description: "BNF-like grammar specification" },
