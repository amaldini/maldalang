...
const FALLBACK_TOC_CHAPTERS = [
    ...
    { file: "18-agent-orchestration.html", title: "Agent Orchestration", num: "18", category: "AI & Agents", description: "LLM clients, agents, tools, teams, and agent kits" },
    ...
    { file: "23-agentic-runs.html", title: "Agentic Runs", num: "23", category: "AI & Agents", description: "How to test, record, time-limit, remember, restrict, and diagnose agent programs" },
    { file: "24-web-ui-hub.html", title: "Web UI Overview", num: "24", category: "Web", description: "Choose server components, HttpServer pages, browser JS, or games" },
    ...
    { file: "34-examples.html", title: "Examples", num: "34", category: "Reference", description: "First Look, Examples/ catalog, and one snippet per track" },
...
const FALLBACK_TOC_CHAPTERS_IT = [
    ...
    { file: "18-agent-orchestration.html", title: "Orchestrazione di agenti", num: "18", category: "AI & Agents", description: "Client LLM, agenti, tool, team e kit di agenti" },
    ...
    { file: "23-agentic-runs.html", title: "Esecuzioni agentiche", num: "23", category: "AI & Agents", description: "Come testare, registrare, limitare nel tempo, ricordare, restringere e diagnosticare i programmi agentici" },
    { file: "24-web-ui-hub.html", title: "Panoramica Web UI", num: "24", category: "Web", description: "Scegliere componenti server, pagine HttpServer, JS nel browser o giochi" },
    ...
    { file: "34-examples.html", title: "Esempi", num: "34", category: "Reference", description: "First Look, catalogo Examples/ e un snippet per traccia" },
