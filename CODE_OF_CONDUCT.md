...
([@amaldini](https://github.com/amaldini))
or, for sensitive reports, via
[GitHub Security Advisories](https://github.com/amaldini/maldalang/security/advisories/new)
(state that the report is a Code of Conduct matter; do not include vulnerability
details unless the report is also a security issue).
