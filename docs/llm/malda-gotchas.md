...
| `var n: int = "abc";` | Runs at runtime. The language server emits a **Warning** for literal initializer mismatches; nothing enforces hints at runtime. | Fix the literal, validate explicitly, or use `toIntOrNull` |
