...
**Spec:** [docs/spec/malda-language-1.0.md](../spec/malda-language-1.0.md) (Draft 1.0) · [CHANGELOG](../spec/CHANGELOG.md) · Grammar [22-grammar.html](../../ReferenceManual/22-grammar.html)

| # | Task | Output |
|---|------|--------|
| 2.1 | Spec document | [x] [malda-language-1.0.md](../spec/malda-language-1.0.md) — types, coercion, `match`, async, actors, null |
| 2.2 | Complete grammar | [x] Expanded `ReferenceManual/22-grammar.html` + `ReferenceManualGrammarCoverageTests` |
...
| 2026-06-04 | Phase 2.2: Expanded `22-grammar.html`, grammar coverage tests |
