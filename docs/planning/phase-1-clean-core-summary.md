...
**Phase 2 complete:** Spec [1.0](../spec/malda-language-1.0.md), grammar [22-grammar.html](../../ReferenceManual/22-grammar.html), [CHANGELOG](../spec/CHANGELOG.md), CI `verify-spec-guards.ps1`. Next: Phase 3 (modules) or Phase 5 (conformance matrix).
